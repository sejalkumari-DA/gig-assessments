...
export default function AudioAssessmentPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Navigate directly to recording page with type=audio
    ...
    <main className="min-h-screen bg-background text-foreground flex items-center justify-center p-8">
      <Card className="w-full max-w-md p-8 shadow-sm">
        <div className="text-center mb-8">
          <h1 className="text-xl font-normal mb-2">Job Audio Assessment</h1>
          <p className="text-xs text-muted-foreground">Enter your details to take the audio assessment for this role.</p>
        </div>
